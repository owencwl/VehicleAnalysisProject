...
/**
 * @ClassName UmxSloppyMath
 * @Description Todo
 * @Author owen(umxwe)
 * @Date 2021/3/3
 */
public class UmxSloppyMath {
     ...
     * #haversinMeters(double, double, double, double)}, but it always compares the same. This can
     * be converted into an actual distance with {@link #haversinMeters(double)}, which effectively
     * does the second half of the computation.
     */
     ...
     * <p>
     * The returned angle is in the range <i>-pi</i>/2 through <i>pi</i>/2. Error is around 1E-7.
     * <p>
     * Special cases:
     * <ul>
