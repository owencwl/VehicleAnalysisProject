 ...
 *
 * @param <V> the type of the com.umxwe.common.param value
 */
@PublicEvolving
public class ParamInfo<V> {
     ...
     *
     * @return {@code true} if the com.umxwe.common.param is optional, {@code false} otherwise
     */
     ...
     *
     * @return the default value of the com.umxwe.common.param, {@code null} if not defined
     */
    ...
    /**
     * Returns the class of the com.umxwe.common.param value. It's usually needed in serialization.
     *
